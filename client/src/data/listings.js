...
export const listings = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  // Added from https://www.airbnb.co.in/rooms/1771617237560559238 — a
  // brand-new Airbnb listing (2 months hosting, 1 review) at the time
  // this was added, so two things below are flagged rather than guessed:
  //   - `price`: Airbnb only shows this listing's nightly price once you
  //     pick check-in/check-out dates, so it isn't in the page source.
  //     Left at 0 for now — the site shows "See price on Airbnb" on the
  //     card and a "See live price on Airbnb" note on its page until you
  //     fill in a real number here.
  //   - `rating`: Airbnb only publishes a public star average once a
  //     listing has 3+ reviews; this one has 1. Left as `null` — the
  //     site shows a "New" badge (matching Airbnb's own "New" status)
  //     instead of a fabricated number until it crosses that threshold.
  //     `reviewCount: 1` IS the real figure shown on the listing page.
  //   - `images`: hotlinked straight from Airbnb's own CDN (a0.muscache.com)
  //     rather than downloaded and hosted locally like Nirvana's photos —
  //     download the real photos and swap these for local /property/...
  //     paths when convenient, for reliability and site performance.
  //   - `amenities`: Airbnb's page listed 30 total but only previewed a
  //     handful without expanding the full panel — only the ones actually
  //     visible are included below; add the rest by checking the listing.
  // ─────────────────────────────────────────────────────────────────────
  {
    hotelId: 'willow-retreat-udaipur',
    name: 'Willow Retreat',
    type: 'Apartment',
    location: 'Udaipur, Rajasthan',
    description:
      'Willow Retreat is a spacious 2BHK flat near Sajjangarh (Monsoon Palace), in a quiet residential pocket of Udaipur just a short drive from City Palace and Lake Pichola. Both bedrooms are air-conditioned, the kitchen comes fully equipped for home-cooked meals, and a comfortable hall gives you a place to unwind. Free parking and lift access are included, and pets are welcome.',
    price: 0,
    airbnbLink: 'https://www.airbnb.co.in/rooms/1771617237560559238',
    rating: null,
    reviewCount: 1,
    guests: 6,
    bedrooms: 2,
    bathrooms: 2,
    images: [
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/baa00fd5-2adf-49af-a1c1-c791777ea046.png',
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/83fa9601-7041-4116-8455-fe5846eff85d.png',
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/acb5ffad-0a04-4937-95bc-c30c3dde6a65.png',
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/8ecbb43f-0116-4748-842e-f7ad8bef1a9b.png',
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/a15f8faa-bc99-459f-bdce-9612844cfd67.png',
      'https://a0.muscache.com/im/pictures/hosting/Hosting-1771617237560559238/original/aa64ed10-65f6-4015-9f53-5c3a17e752d8.png',
    ],
    amenities: [
      'Air conditioning',
      'Kitchen',
