...
import useLiveStats, { FOUNDED_YEAR } from '../lib/useLiveStats';
...
export default function AboutUs() {
  // Stats are computed live from src/data/listings.js (the site's one
  // source of truth for properties) instead of being hardcoded — see
  // src/lib/useLiveStats.js.
  const { stats, propertiesManaged, destinations, guestSatisfactionPct } =
    useLiveStats(listings);
    ...
    <div className="about">
      ...
      <section className="about__hero">
        <div className="about__hero-bg">
          <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1400&q=80" alt="Beautiful property" fetchpriority="high" />
      ...
      <section className="about__story">
        <div className="container about__story-grid">
          ...
          <div className="about__story-right">
            ...
            <p>
              We stepped in to bridge that gap. We don't buy properties. Instead, we either take them on lease or enter into revenue-sharing partnerships with owners — and then we do what we do best: transform them into premium hospitality experiences, list them on Airbnb, and manage them end-to-end.
            </p>
            <p>
              Since {FOUNDED_YEAR}, we've grown to manage {propertiesManaged} {propertiesManaged === 1 ? 'property' : 'properties'} across {destinations} {destinations === 1 ? 'destination' : 'destinations'} in India{guestSatisfactionPct != null ? `, maintaining a ${guestSatisfactionPct}% guest satisfaction rate` : ''} and consistently generating above-market returns for our property partners.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="about__cta">
        ...
        <div className="container about__cta-inner">
          ...
          <Link to="/contact" className="btn-primary btn-jewel">Get In Touch →</Link>
        </div>
      </section>
